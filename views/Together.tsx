  ...
  return (
    <Container className="mt-20">
      <div className="relative py-4">
        ...
        <p className="text-center text-xl font-bold">At the end of the day, you&apos;re not alone</p>
      ...
      <div className="mt-10">
        <div className="flex gap-6">
          ...
          <Image className="flex-none rounded-lg" src="/assets/images/together.png" alt="no img" width={401} height={287} />
        </div>
