...
const Guarantee: FC = () => {
  return (
    <Container className="mt-24 bg-black border border-solid border-secondary rounded-[7px] py-14 px-[30px] flex flex-col gap-8 text-white text-center">
      <div className="mt-4 relative py-4 w-full">
        <div className="absolute top-0 w-full h-[1.5px] bg-white" />
        <p className="text-center text-xl font-bold">The &quot;Lose Weight, Feel Great&quot; Guarantee</p>
      ...
      <p>
        And because we’re so confident that we can help you on your journey to a better, lighter you, MD Exam offers a full “Lose Weight, Feel Great”
        guarantee on all of our programs.
      </p>
      <p>
        If you do your part, follow your recommended plan, and <span className="font-bold">STILL</span> aren’t losing weight within the first 90 days,{' '}
        <span className="font-bold">we’ll give you a full refund on the spot.</span>
      </p>
