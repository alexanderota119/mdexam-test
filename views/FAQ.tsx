  ...
  return (
    <Container className="mt-20 text-center">
      <div className="mt-4 relative py-4 w-full">
        ...
        <p className="text-[30px] leading-10 sm:text-xl font-bold">FAQ</p>
        <div className="absolute bottom-0 w-full h-[2px] bg-black" />
      </div>
      <div className="mt-20 flex flex-col gap-5">
        <button
          type="button"
          className={`w-full h-[60px] sm:h-[52px] rounded-[7px] ${activeFAQ === 0 ? 'bg-secondary' : 'bg-primary'} hover:bg-secondary`}
          onClick={() => setActiveFAQ(0)}
        >
          <span className={`${activeFAQ === 0 ? 'text-black' : 'text-white'} text-base sm:text-[20px] font-bold`}>
        ...
        <button
          type="button"
          className={`w-full h-[60px] sm:h-[52px] rounded-[7px] ${activeFAQ === 1 ? 'bg-secondary' : 'bg-primary'} hover:bg-secondary`}
          onClick={() => setActiveFAQ(1)}
        >
          <span className={`${activeFAQ === 1 ? 'text-black' : 'text-white'} text-base sm:text-[20px] font-bold`}>
        ...
        <button
          type="button"
          className={`w-full h-[60px] sm:h-[52px] rounded-[7px] ${activeFAQ === 2 ? 'bg-secondary' : 'bg-primary'} hover:bg-secondary`}
          onClick={() => setActiveFAQ(2)}
        >
          <span className={`${activeFAQ === 2 ? 'text-black' : 'text-white'} text-base sm:text-[20px] font-bold`}>
